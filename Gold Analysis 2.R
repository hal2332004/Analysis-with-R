...
cor_crude_oil <- cor.test(df$Crude_oil, df$Gold_Price, method = "pearson")
print(cor_crude_oil)

cor_interest <- cor.test(df$interest, df$Gold_Price, method = "pearson")
print(cor_interest)

cor_usd_USD_INR <- cor.test(df$USD_INR, df$Gold_Price, method = "pearson")
print(cor_USD_INR)

cor_sensex <- cor.test(df$sensex, df$Gold_Price, method = "pearson")
print(cor_sensex)
